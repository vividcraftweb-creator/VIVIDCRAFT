...
async function seedAdmin() {
  ...
  try {
    ...
    if (listError) {
      ...
      authUser = userList.users.find(u => u.email && u.email.toLowerCase() === ADMIN_EMAIL.toLowerCase());
    }
  } catch (listCatchErr) {
  ...
  try {
    ...
    console.log('[Seed Admin Info] Note: You can also apply supabase/migrations/20260829000000_seed_admin_user.sql directly to the database.');
  }
