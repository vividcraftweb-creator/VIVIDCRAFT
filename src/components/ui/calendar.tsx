  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative border-2 border-slate-700 bg-slate-800/80 shadow-sm rounded-lg",
          "hover:border-primary/50 hover:bg-slate-700/80 transition-all",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "text-sm [&>svg]:text-slate-400 [&>svg]:size-4",
