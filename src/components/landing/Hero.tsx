      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center gap-8 sm:gap-12 px-4 text-center sm:px-6">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-amber-200/60 dark:border-amber-500/30 bg-amber-50/70 dark:bg-amber-500/10 backdrop-blur-md px-3 sm:px-4 py-1.5 sm:py-2 shadow-sm">
            <span className="text-xs sm:text-sm font-semibold text-amber-800 dark:text-amber-300 sm:text-base">✨ The Art Marketplace</span>
          </div>
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto px-8 py-4 text-lg font-semibold interactive-scale shadow-lg group-hover:shadow-xl bg-amber-500 text-slate-950 hover:bg-amber-400 shadow-amber-500/20 rounded-full"
