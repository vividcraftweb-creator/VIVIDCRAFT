        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div
            ...
            className={`relative p-6 rounded-2xl border text-left cursor-pointer transition-all ${
              selectedRole === 'artist'
                ? 'bg-amber-950/30 border-amber-500 shadow-xl shadow-amber-500/15 ring-2 ring-amber-500/40'
          ...
          >
            ...
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-amber-500/15 text-amber-400 mb-4 border border-amber-500/30">
