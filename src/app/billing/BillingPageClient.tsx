    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <Alert className="border-2 border-amber-500/40 bg-gradient-to-r from-amber-500/20 to-orange-500/20 backdrop-blur">
        ...
        <AlertTitle className="text-xl font-bold text-white">
          Important: Cinnamon Gallery Does Not Process Payments
        </AlertTitle>
        <AlertDescription className="text-base text-slate-200 space-y-2 mt-3">
          <p className="font-medium">
            Cinnamon Gallery is a <span className="text-amber-300 font-bold">connection platform only</span>.
      ...
      <Card className="glass-card border-white/10 bg-white/5">
        <CardHeader>
          ...
          <CardDescription>
            Understanding what Cinnamon Gallery provides and what you handle directly
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-emerald-400 flex items-center gap-2">
                ...
                What Cinnamon Gallery Provides
              </h3>
              ...
              <div className="space-y-3 text-sm text-slate-300">
                <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 mt-1">Cinnamon Gallery never holds, processes, or transfers money between parties</p>
                  </div>
                </div>
      ...
      {isClient ? (
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="mt-2">
                  Track invoices generated through Cinnamon Gallery. These are for record-keeping only.
                </CardDescription>
              </div>
          ...
          <CardContent>
            <div className="mb-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
              <p className="text-sm text-slate-300">
                ...
                your freelancer using the payment method you both agreed upon. Cinnamon Gallery invoices are
        ...
        <Card className="glass-card border-white/10 bg-white/5">
          <CardHeader>
            ...
            <CardDescription>
              How to get paid for your work on Cinnamon Gallery projects
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <Alert className="border-blue-500/30 bg-blue-500/10">
              ...
              <AlertDescription className="text-slate-300">
                Cinnamon Gallery does not run an escrow or payout service. You and your client
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">
                      Use Cinnamon Gallery messaging and project tracking tools to share updates,
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">
                      Generate a professional invoice within Cinnamon Gallery for documentation,
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">
                      ...
                      directly with the client through Cinnamon Gallery messaging or email.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">
                      Once payment is received, acknowledge receipt in your Cinnamon Gallery message thread.
      ...
      <Card className="glass-card border-white/10 bg-white/5">
        ...
        <CardContent>
          ...
          <div className="text-sm text-slate-400">
            <Info className="h-4 w-4 inline-block mr-2 text-blue-400" />
            <strong className="text-white">Note:</strong> Cinnamon Gallery is not affiliated with these providers
      ...
      <Card className="glass-card border-white/10 bg-white/5">
        <CardHeader>
          ...
          <CardDescription>
            Common questions about payments on Cinnamon Gallery
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Q1 */}
          <div>
            <h4 className="font-semibold text-white mb-2 flex items-center gap-2">
              ...
              Why doesn&apos;t Cinnamon Gallery process payments?
            </h4>
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 pl-6">
              First, reach out to the client directly through Cinnamon Gallery messaging to resolve the issue.
              If unresolved, contact{' '}
              <Link href="/support" className="text-primary underline">
                Cinnamon Gallery Support
              </Link>
          ...
          <div>
            <h4 className="font-semibold text-white mb-2 flex items-center gap-2">
              <ArrowRight className="h-4 w-4 text-primary" />
              Can I request a refund through Cinnamon Gallery?
            </h4>
            <p className="text-sm text-slate-400 pl-6">
              No. Since Cinnamon Gallery does not process payments, we cannot issue refunds. Payment disputes,
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 pl-6">
              ...
              new clients. (4) Keep all communication and receipts in Cinnamon Gallery messaging.
              (5) Use payment methods with buyer/seller protection (PayPal, Stripe).
              (6) Verify client identity through their Cinnamon Gallery verified badge.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-semibold text-white mb-2 flex items-center gap-2">
              <ArrowRight className="h-4 w-4 text-primary" />
              Do I need to pay taxes on income earned through Cinnamon Gallery?
            </h4>
            <p className="text-sm text-slate-400 pl-6">
              Yes. You are responsible for reporting and paying taxes on all income earned, regardless
              of the platform you use. Cinnamon Gallery does not issue tax forms (1099, W-2, etc.) since we
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 pl-6">
              Cinnamon Gallery invoices are documentation and record-keeping tools only. They help you track
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Confirm deliverables, timelines, and payment schedules in writing. Use Cinnamon Gallery
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    After each payment, share receipts or confirmations in your Cinnamon Gallery message
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-slate-400 space-y-2">
            <p className="font-medium text-slate-300">
              Cinnamon Gallery Platform Disclaimer
            </p>
            <p>
              Cinnamon Gallery is a professional connection and project management platform. We do not hold,
            ...
            <p>
              Cinnamon Gallery cannot issue refunds, release payments, mediate financial disputes, or provide
