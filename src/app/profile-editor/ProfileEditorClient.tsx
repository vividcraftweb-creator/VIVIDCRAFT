...
export default function ProfileEditorPage() {
  ...
  const effectiveProfile = useMemo(() => {
    ...
    return {
      ...
      profilePicture: (fromQuery?.profilePicture && !fromQuery.profilePicture.startsWith('data:') ? fromQuery.profilePicture : '') || (fromQuery?.avatar_url && !fromQuery.avatar_url.startsWith('data:') ? fromQuery.avatar_url : '') || (user?.image && !user.image.startsWith('data:') ? user.image : '') || '',
      avatar_url: (fromQuery?.avatar_url && !fromQuery.avatar_url.startsWith('data:') ? fromQuery.avatar_url : '') || (fromQuery?.profilePicture && !fromQuery.profilePicture.startsWith('data:') ? fromQuery.profilePicture : '') || (user?.image && !user.image.startsWith('data:') ? user.image : '') || '',
      role: 'artist',
