      ...
      try {
        ...
        try {
            ...
            try {
              ...
              await supabase.auth.admin.updateUserById(userId, {
                user_metadata: {
                  ...
                  bio: existingMeta.bio || (fallbackRole === 'artist' ? 'Welcome to Cinnamon Gallery!' : ''),
          ...
          return {
            ...
            email: userEmail || data?.email || 'artist@cinnamongallery.com',
            role: normalizedRole,
            ...
            bio: data?.bio || data?.description || (normalizedRole === 'artist' ? 'Welcome to Cinnamon Gallery!' : ''),
